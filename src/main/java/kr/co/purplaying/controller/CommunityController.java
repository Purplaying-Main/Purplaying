...
public class CommunityController {
  ...
  @ResponseBody
  public ResponseEntity<List<CommunityDto>> list(Integer prdt_id) {
   ...
   * 
   * @ResponseBody
   * public List<CommunityDto> list2(@RequestBody CommunityDto communityDto, int
   * chat_no, Model m) {
   * List<CommunityDto> list = null;
...
////댓글 작성
  @PostMapping("/community")
  public ResponseEntity<String> write(@RequestBody CommunityDto dto, Integer chat_no, HttpSession session) {
