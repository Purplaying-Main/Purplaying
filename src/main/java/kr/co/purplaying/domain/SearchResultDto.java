...
public class SearchResultDto {
  ...
  public SearchResultDto(String writer, Integer prdt_id, String prdt_name, String prdt_desc, String prdt_desc_detail,
  ...
  @Override
  public int hashCode() {
    return Objects.hash(keyword, prdt_currenttotal, prdt_dday, prdt_desc, prdt_desc_detail, prdt_desc_policy,
        prdt_enddate, prdt_genre, prdt_goal, prdt_id, prdt_limitday, prdt_name, prdt_open, prdt_opendate, prdt_percent,
        prdt_purchaseday, prdt_regdate, prdt_thumbnail, prdt_user_no, user_activate, user_id, user_name, user_no,
        user_phone, user_pwd, user_regdate, user_role, writer);
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(keyword, other.keyword) && Objects.equals(prdt_currenttotal, other.prdt_currenttotal)
        && prdt_dday == other.prdt_dday && Objects.equals(prdt_desc, other.prdt_desc)
        ...
        && Objects.equals(prdt_name, other.prdt_name) && prdt_open == other.prdt_open
        && Objects.equals(prdt_opendate, other.prdt_opendate) && prdt_percent == other.prdt_percent
        && Objects.equals(prdt_purchaseday, other.prdt_purchaseday) && Objects.equals(prdt_regdate, other.prdt_regdate)
        && Objects.equals(prdt_thumbnail, other.prdt_thumbnail) && prdt_user_no == other.prdt_user_no
