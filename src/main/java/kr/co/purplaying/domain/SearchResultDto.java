...
public class SearchResultDto {
  ...
  public SearchResultDto(int prdt_id, int prdt_genre, String prdt_name) {
    //super();
  ...
  public String toString() {
    return "searchResultDto [prdt_id=" + prdt_id + ", prdt_genre=" + prdt_genre + ", prdt_name=" + prdt_name
        + ", prdt_opendate=" + prdt_opendate + ", prdt_enddate=" + prdt_enddate + ", prdt_goal=" + prdt_goal
        + ", prdt_currenttotal=" + prdt_currenttotal + ", prdt_rank=" + prdt_rank + ", prdt_percent=" + prdt_percent
        + ", prdt_dday=" + prdt_dday + "]";
  }
