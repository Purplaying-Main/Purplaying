...
public class AlarmDto {
  ...
  public AlarmDto(int alarm_no, int alarm_cnt, Date alarm_regdate, int like_id, int prdt_id, int prdt_comingday, int prdt_dday,
                  String user_id, String prdt_thumbnail, String prdt_name) {
    super();
  ...
  public String toString() {
    return "AlarmDto [alarm_no=" + alarm_no + ", alarm_cnt=" + alarm_cnt + ", alarm_regdate=" + alarm_regdate
        + ", like_id=" + like_id + ", prdt_id=" + prdt_id + ", prdt_comingday=" + prdt_comingday + ", prdt_dday=" + prdt_dday
        + ", user_id=" + user_id+", prdt_thumbnail=" + prdt_thumbnail+", prdt_name=" + prdt_name+  "]";
  }
