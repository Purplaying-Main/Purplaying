        ...
        <div class="dropdown text-end">
          ...
          <div style="${loginDisplay}"> <!-- 로그인 후 보이는 화면 : 프로필-->
	          ...
	          <ul class="dropdown-menu text-small">
	            ...
	            <li><button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#pointpayModal">포인트 충전하기 <i class="fa-solid fa-sack-dollar" style="color:#9E62FA"></i></button></li>
