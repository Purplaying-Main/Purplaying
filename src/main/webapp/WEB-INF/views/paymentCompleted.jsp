    ...
    <div class="contentsWrap">
      ...
      <div class="row col-md-8 d-block mx-auto">
        ...
        <div class="d-flex justify-content-end mb-2">
          <a class="btn btn-primary" href="mypage.html">주문내역확인</a>
          <a class="btn btn-secondary ms-2" href="home.html">메인으로</a>
        </div>
  ...
  <footer class="p-5">
    ...
    <div class="py-4 border-top">
      <p class="nav flex-column mb-3">
        회사명 퍼플레잉㈜ | 주소 서울 서초구 서초대로 77길, 54 (서초더블유타워 13,14층) | 대표 이순신 | 사업자등록번호 167-85-00921 | 통신판매업 신고번호
        제2018-서울서초-0507호 | 대표번호 1644-0685 &copy; 2022 Purplaying Inc.
      </p>
      <p class="nav flex-column text-small text-muted">퍼플레잉은 플랫폼 제공자로서 프로젝트의 당사자가 아니며, 직접적인 통신판매를 진행하지 않습니다. 프로젝트의 완수 및
        선물제공의 책임은 해당 프로젝트의 창작자에게 있으며, 프로젝트와 관련하여 후원자와 발생하는 법적 분쟁에 대한 책임은 해당 창작자가 부담합니다.
      </p>
    </div>
  </footer>
</body>
