window.onload = function () {
    ...
    document.getElementById("address_num").addEventListener("click", function () {
        //주소입력칸을 클릭하면
        //카카오 지도 발생
        new daum.Postcode({
            oncomplete: function (data) {
    ...
    document.getElementById("Modaddress").addEventListener("click", function () {
        //주소입력칸을 클릭하면
		
		document.getElementById("Modaddress_num").value = ""; //우편번호
        document.getElementById("Modaddress").value = ""; //주소
    ...
    document.getElementById("Modaddress_num").addEventListener("click", function () {
        //주소입력칸을 클릭하면
